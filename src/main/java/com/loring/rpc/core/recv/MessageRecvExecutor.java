...
import com.loring.rpc.core.NameThreadFactory;
import com.loring.rpc.core.RpcThreadPool;
import com.loring.rpc.model.MessageKeyVal;
...
public class MessageRecvExecutor implements ApplicationContextAware, InitializingBean {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        try {
            MessageKeyVal messageKeyVal = (MessageKeyVal) applicationContext.getBean(Class.forName("com.loring.rpc.model.MessageKeyVal"));
